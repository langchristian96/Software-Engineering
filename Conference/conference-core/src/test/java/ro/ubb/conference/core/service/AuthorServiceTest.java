...
public class AuthorServiceTest {
    ...
    public void createAuthor() throws Exception {
        ...
        authorService.createAuthor("Author11","pass1","David Bowie2","corporatie", "authoristic@gmail.com");
    ...
    public void deleteAuthor() throws Exception {
        ...
        authorService.createAuthor("Author13","pass12","David Bowie23","corporatie", "authoristic@gmail.com");
        Long id = authorService.findAll().get(0).getId();
        authorService.deleteAuthor(id);
